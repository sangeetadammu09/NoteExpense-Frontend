...
function LoginPage() {
    ...
    const [email, setEmail] = useState("sangeetadammu12@gmail.com");
  ...
  return (
	<div className='min-h-screen flex items-center justify-center relative overflow-hidden bg-main'>
		{/* <h2 className='text-3xl font-bold mb-6 text-center text-black-200 bg-clip-text'>
